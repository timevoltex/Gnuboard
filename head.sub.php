...
<head>
  ...
  <?php
  if (G5_IS_MOBILE) {
    echo '<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=0,maximum-scale=1.0,user-scalable=no">' . PHP_EOL;
...
<![endif]-->
  ...
  if (!defined('_POLICY_')) {
    add_javascript('<script src="' . G5_JS_URL . '/pp/jquery.pagepiling.min.js"></script>', 0);
    add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/pp/jquery.pagepiling.min.css">', 0);
  }
  add_javascript('<script src="' . G5_JS_URL . '/fullpage/fullpage.js"></script>', 0);
  add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/font-awesome/css/font-awesome.min.css">', 0);
  add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/fullpage/fullpage.css">', 0);
...
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ' oncontextmenu="return false"
    onselectstart="return false"
    ondragstart="return false"'; ?> <?php
